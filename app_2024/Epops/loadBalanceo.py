...
def yaml_web(dp):
    ...
    with open('/home/du/Prototipo_App2024/app2024/Epops/balanceo/balanceo_web.yaml', 'w') as file:
...
def yaml_datos(conexiones):
    ...
    with open('/home/du/Prototipo_App2024/app2024/Epops/balanceo/balanceo_datos.yaml', 'w') as file:
