...
def configurar_stpCost_cisco(connection, interfaz, costo, save_config=False):
    """
...
def configurar_stpCost_hp(connection, interfaz, modo, costo, vlan=None, instance=None, save_config=False):
    """
...
def configurar_stpCost_3com(ip, username, password, interfaz, modo, costo, vlan=None, instance=None, save_config=False):
    """
...
def comandos_stpCost_tplink(interfaz, instance, cost, archivo_destino=None):
    ...
    if archivo_destino is None:
        ...
        archivo_destino = os.path.join(current_dir, 'comandos', 'comandos_stp_cost.txt')
