...
def crear_grafo(direcciones, conexiones, etiquetas,nodb):
    ...
    for direccion in direcciones:
        ...
        G.add_node(nodo_id, size=1500, color=colores['principal'])  # Asignar color azul a los nodos principales
    ...
    for conexion in conexiones:
        ...
        G.add_node(subnodo_id, size=700, color=colores['subnodo'])  # Asignar color verde a los subnodos
        G.add_node(tupla_id, size=700, color=colores['subnodo'])    # Asignar color verde a los subnodos
    ...
    for xn in nodb:
        G.add_node(xn, size=700, color=colores['subnodob'])    # Asignar color verde a los subnodos
